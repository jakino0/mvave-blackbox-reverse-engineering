...
- Updated the next target to the opcode-2 event producer and local-DSP object
  identity; retained the warning that raw list removal is not a safe audio stop.
